...
from py_captcha.rotate.option import Options, default_options
from py_captcha.rotate.resource import Resources, default_resource
from py_captcha.rotate.rotate import RotateCaptcha
