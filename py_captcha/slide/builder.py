...
from py_captcha.slide.option import DeadZoneDirectionType, Options, default_options
from py_captcha.slide.resource import Resources, default_resource
from py_captcha.slide.slide import Mode, SlideCaptcha
